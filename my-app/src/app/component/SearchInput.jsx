  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="search-input w-full pl-10 pr-10 py-3 rounded-xl text-sm outline-none transition-all duration-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-300 hover:border-amber-400"
        style={{
