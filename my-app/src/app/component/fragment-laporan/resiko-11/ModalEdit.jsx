...
export const ModalEdit = ({ item, checkFetchData }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    ResikoBaru: item?.ResikoBaru || "",
    mitigasiResiko: item?.mitigasiResiko || "",
    statusResiko: item?.statusResiko || "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`/api/laporan/resiko/${item.id}`, {
        method: "PUT",
        headers: {
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Edit Resiko Baru Yang Teridentifikasi
                      </span>
                    </label>
                    <div className="relative">
                      <textarea
                        id="ResikoBaru"
                        name="ResikoBaru"
                        placeholder="Masukan Resiko Baru"
                        value={formData.ResikoBaru}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        rows={4}
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative">
                      <textarea
                        id="mitigasiResiko"
                        name="mitigasiResiko"
                        placeholder="Masukan Mitigasi Resiko"
                        value={formData.mitigasiResiko}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        rows={4}
                        className="w-full rounded-xl px-4 py-3 text-base border-2 border-gray-500 bg-transparent focus:outline-none focus:ring-2 focus:ring-amber-500 placeholder-gray-400 resize-none"
