...
export const TableInfoUmum = ({ data, onFetchData }) => {
  ...
  const handleConfirmBulkDelete = async () => {
    setIsLoading(true);
    try {
      const res = await fetch("/api/laporan/info-umum/bulk-delete", {
        method: "DELETE",
  ...
  const generatePDF = () => {
    try {
      ...
      autoTable(doc, {
        ...
        head: [["No", "Nama", "Periode", "Tanggal Dibuat", "Dibuat Oleh"]],
        body: tableBody,
        theme: "striped",
        styles: {
          fontSize: 9,
        ...
        <table className="min-w-full">
          ...
          >
            ...
            >
              ...
              <th className="px-6 py-3 whitespace-nowrap  text-left text-xs font-bold uppercase tracking-wider">
                Nama
              </th>
