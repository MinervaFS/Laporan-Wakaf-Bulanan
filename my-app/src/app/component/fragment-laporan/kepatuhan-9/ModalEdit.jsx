...
export const ModalEdit = ({ item, checkFetchData }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    jumlahDokTerintegrasi: item?.jumlahDokTerintegrasi || 0,
    jenisDokBaru: item?.jenisDokBaru || "",
    catatanRegulasi: item?.catatanRegulasi || "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`/api/laporan/kepatuhan/${item.id}`, {
        method: "PUT",
        headers: {
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Edit Jumlah Dokumen Teregistrasi
                      </span>
                    </label>
                    <div className="relative">
                      <input
                        id="jumlahDokTerintegrasi"
                        type="number"
                        name="jumlahDokTerintegrasi"
                        placeholder="Masukan jumlah dokumen teregistrasi "
                        value={formData.jumlahDokTerintegrasi}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        className="w-full rounded-xl px-4 py-3 text-base border-2 border-gray-500 bg-transparent focus:outline-none focus:ring-2 focus:ring-amber-500 placeholder-gray-400"
                        style={{
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Edit Jumlah Jenis Dokumen Baru
                      </span>
                    </label>
                    <div className="relative">
                      <textarea
                        id="jenisDokBaru"
                        name="jenisDokBaru"
                        placeholder="Masukan Jenis Dokumen Baru"
                        value={formData.jenisDokBaru}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        rows={4}
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Edit Kendala Regulasi
                      </span>
                    </label>
                    <div className="relative">
                      <textarea
                        id="catatanRegulasi"
                        name="catatanRegulasi"
                        placeholder="Masukan kendala regulasi"
                        value={formData.catatanRegulasi}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        rows={4}
                        className="w-full rounded-xl px-4 py-3 text-base border-2 border-gray-500 bg-transparent focus:outline-none focus:ring-2 focus:ring-amber-500 placeholder-gray-400 resize-none"
