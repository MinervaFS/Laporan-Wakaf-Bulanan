...
export const ModalCreate = ({ checkFetchData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validasi input
    // if (!formData.pengemabanganSistem.trim()) {
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Catatan/Kendala Teknis & Non Teknis
                      </span>
                    </label>
                    <div className="relative">
                      <textarea
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      !formData.name.trim() ||
                      !formData.periode ||
                      formData.pengemabanganSistem === "" ||
                      formData.catatanTeknisNonTeknis === ""
                    }
                  >
                    {isLoading ? (
                      <>
