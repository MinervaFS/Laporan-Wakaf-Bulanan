...
export const ModalEdit = ({ item, checkFetchData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`/api/laporan/pengelolaan-asset/${item.id}`, {
        method: "PUT",
        headers: {
