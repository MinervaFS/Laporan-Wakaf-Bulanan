...
export const ModalCreate = ({ checkFetchData }) => {
  ...
  const [formData, setFormData] = useState({
    name: "",
    periode: "",
    jumlahAssetDikelola: null || 0,
    penghasialAsset: null || 0,
    jenisPengelolaanBaru: "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/laporan/pengelolaan-asset", {
        method: "POST",
        headers: {
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Jumlah Asset Dikelola
                      </span>
                    </label>
                    <div className="relative">
                      <input
                        id="jumlahAssetDikelola"
                        type="number"
                        name="jumlahAssetDikelola"
                        placeholder="Masukan jumlah asset dikelola"
                        value={formData.jumlahAssetDikelola}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        className="w-full rounded-xl px-4 py-3 text-base border-2 border-gray-500 bg-transparent focus:outline-none focus:ring-2 focus:ring-amber-500 placeholder-gray-400"
                        style={{
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Jenis Pengelolaan Baru
                      </span>
                    </label>
                    <div className="relative">
                      <textarea
                        id="jenisPengelolaanBaru"
                        name="jenisPengelolaanBaru"
                        placeholder="Masukan jenis pengelolaan Baru"
                        value={formData.jenisPengelolaanBaru}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        rows={4}
