...
export const ModalCreate = ({ checkFetchData }) => {
  ...
  const [formData, setFormData] = useState({
    name: "",
    periode: "",
    jumlahAssetDinilai: 0,
    nilaiAssetWakaf: 0,
    catatanPenilaianAsset: "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("/api/laporan/penilaian-asset-wakaf", {
        method: "POST",
        headers: {
