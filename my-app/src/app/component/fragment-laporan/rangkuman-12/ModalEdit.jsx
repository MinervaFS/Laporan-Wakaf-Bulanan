...
export const ModalEdit = ({ item, checkFetchData }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    performaBulanan: item?.performaBulanan || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`/api/laporan/rangkuman/${item.id}`, {
        method: "PUT",
        headers: {
                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      >
                        ...
                        Edit Performa Bulanan
                      </span>
                    </label>
                    <div className="relative">
                      <textarea
                        id="performaBulanan"
                        name="performaBulanan"
                        placeholder="Masukan perfoma bulanan"
                        value={formData.performaBulanan}
                        onChange={handleOnChange}
                        disabled={isLoading}
                        rows={4}
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative">
                      <textarea
                        id="actionPlan"
                        name="actionPlan"
                        placeholder="Masukan Action plan"
