...
import { BtnDeleteAsset, BtnDeleteDoc } from "./Button";
import { BiX, BiTrash, BiLoader } from "react-icons/bi";

export const ModalDeleteAsset = ({ id, checkFetchData }) => {
  ...
  return (
    <div>
      <BtnDeleteAsset openModalDelete={handleModalDeleteOpen} />
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    >
                      Apakah Anda yakin ingin menghapus jenis asset ini? Data
