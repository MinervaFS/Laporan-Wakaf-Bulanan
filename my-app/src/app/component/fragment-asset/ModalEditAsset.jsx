...
import { BtnEditAsset } from "./Button";
import { BiSend, BiLoader } from "react-icons/bi";

export const ModalEditAsset = ({ item, checkFetchData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`/api/master-data/new-document/${item._id}`, {
        ...
        body: JSON.stringify({ newassetType: formData }),
      });
  ...
  return (
    <div>
      <BtnEditAsset openModalEdit={handleModalEditOpen} />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end gap-3 pt-4">
                  ...
                  <Button
                    ...
                    disabled={isLoading || !formData.assetType.trim()}
                  >
                    {isLoading ? (
                      <>
